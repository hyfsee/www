    ...
    <div class="page-container" style="padding:10px">
        <p class="f-20 text-success">
            <?php
				   ...
				   $date_array = getdate();
				   $welcome='';
				   if($date_array['hours']>0&&$date_array['hours']<11){
					$welcome='上午好';

				   }else if($date_array['hours']>=11&&$date_array['hours']<13){
					$welcome='中午好';

				   }else if($date_array['hours']>=13&&$date_array['hours']<18){
					$welcome='下午好';

				   }else if($date_array['hours']>=18&&$date_array['hours']<23){
					$welcome='晚上好';
