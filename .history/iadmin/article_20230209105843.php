...
<body>
    <div class="page-container" style="padding:10px">
        ...
        <table class="table table-border table-bordered table-bg">
            <thead>
                <tr>
                    <th colspan="9" scope="col">文章统计</th>
                </tr>
                <tr class="text-c">
                    <th>序号</th>
                    <th>文章标题</th>
                ...
                <?php
				   ...
				   for($i=0;$i<$datarow;$i++){
					 $sql_arr = mysqli_fetch_assoc($result);
					   ...
					   $date=$sql_arr['date'];
					   $type=$sql_arr['type'];
                       $collection=$sql_arr['collection'];
                       $collectionname=$sql_arr['collectionname'];
				       ...
				       if($state==0){
                        ...
                        <td style="color:green">'.($collection==="0"?"否":"是").'</td> 
                        <td style="color:green">'.$collectionname.'</td>
