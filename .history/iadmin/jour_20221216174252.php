    ...
    <div class="layui-fluid" style="padding-top: 10px;">
        <div class="layui-row">
            ...
            <div class="layui-col-md8">
                <div class="f-14 c-error" style="margin-left: 110px;">注：HU言碎语发布</div></br></br>
                <form class="layui-form" action="result/jours.php" method="post" enctype="multipart/form-data">
