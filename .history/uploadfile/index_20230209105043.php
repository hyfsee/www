...
@ $collecitonname=$_POST['product'];
@ $product=$_POST['product'];
@ $pageviews=$_POST['pageviews'];
@ $picture=$_FILES["file"]["name"];
include('../config.php');

 			 $sql="insert into story(Id,title,auther,picture,type,date,product,content,pageviews) values (null,'$title','$auther','$picture','$type','$date','$product','$content','$pageviews')";//向数据库插入表单传来的值的sql
