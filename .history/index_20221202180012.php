...
<body>
    ...
    <div style="text-align:center;margin:50px 0; font:normal 14px/24px 'MicroSoft YaHei';">
        <p>欢迎来到huhuto的个人休闲区，此页面使用了九宫格的一个前端样式，有需要的同学，可以点击链接下载，不用感谢我，附上下载地址</p>
...
if(!file_exists($lockfile)){   
    ...
    echo '<script>setTimeout(function(){window.location.href="./install.php"},1500)
</script>';
