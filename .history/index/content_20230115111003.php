...
<body style="background-color:#f3f3f3;" onmousemove=/HideMenu()/ oncontextmenu="return false" ondragstart="return false"
    ...
    <div class="layui-fluid" style="padding-top: 10px;">
        <div class="layui-row">
            ...
            <div class="layui-col-md2" style="background-color:#FFFFFF;padding:15px;">
                <div class="layui-card">
                    <div class="layui-card-header">
                        <span class="wzgg">
                            <center><B>————— 每日毒鸡汤 —————</B></center>
                        </span>
                    </div>
			        ...
			        $result= mysqli_query($conn,$sql);
			         $datarow = mysqli_num_rows($result); //长度
			            ...
			            for($i=0;$i<$datarow;$i++){
			                ...
			                $title = $sql_arr['title'];
											$id = $sql_arr['Id'];
											 echo '<li clss="lis1"><span class="lis2">'.$a.'</span><a href="../index/content.php?id='.$id.'" target="_black">'.$title.'</a>
                ...
                <div class="layui-col-md5"
                    style="background-color:#FFFFFF;box-shadow: 3px 3px 5px #888888;padding:0 70px;">
                    <?php
		  include('../config.php');
			  $id=$_GET['id'];
