 ...
 <div class="layui-fluid" style="padding-top: 10px;">  
  <div class="layui-row">
    ...
    <div class="layui-col-md6">
		...
		<div class="layui-card-header"><span class="techloarg">当前标签 &nbsp;>><span style="padding: 2px 10px; background-color: #008080; color: #FFFFFF;"><b><?php echo $_GET['type'] ?></b></span></div>
					<?php
		include('../config.php');
