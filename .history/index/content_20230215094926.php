            ...
            <div class="layui-col-md2" style="background-color:#FFFFFF;padding:15px;margin-right:8px">
                <div class="layui-card">
				   ...
				   $sqlQuery="select * from story where id=$id";
					 ...
					 $collectionname = $arr['collectionname'];
					 $collection = $arr['collection'];
					$sql1="select * from story WHERE collection='1' and collectionname='$collectionname' ORDER BY ranking ASC";
		  ...
		  include('../config.php');
			  ...
			  $sql="select * from story where id=$id";
		        ...
		        $title = $sql_arr['title'];
							...
							echo '<center>		
						 <h3><br>'.$title.'</h3></center><br><hr ><div style="align:left"><span style="padding: 0 15px"><i class="layui-icon layui-icon-face-smile" ></i>&nbsp;&nbsp;'.$auther.'</span>
