...
?>  
 ...
 type="text"name="host"value="localhost"><br>  
    ...
    用户名:<input
 type="text"name="username"value="root"><br>  
...
$_POST['password']!=""
 && $_POST['db']!="")  
  ...
  $conn=mysql_connect($localhost,$username,$password,$db);  
 ...
 DATABASE `".$db."`";   
  ...
  mysql_query($sql_create_table_message,$conn);
  mysql_query( $sql_create_table_story,$conn);
  mysql_query($sql_create_table_timeline,$conn);
